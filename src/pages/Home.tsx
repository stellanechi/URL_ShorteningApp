...
function Home() {
  return (
    <>
      ...
      <article>
        {/* ANIMATION */}
        <div className="flex items-center justify-center text-3xl md:text-xl font-bold mb-4 bg-gradient-to-r from-pink-500 via-indigo-500 to-pink-500 text-transparent bg-clip-text">
          <TypeAnimation
            sequence={[
